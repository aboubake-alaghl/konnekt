...
import links, { AboutUS, Application, KPNToken } from "@/data/links";
...
const Navbar = (): JSX.Element => {
    ...
    const drawer = (
        <List sx={{
            ...
            <ListItem >
                <Link passHref href={'https://store.konnektvpn.com/'}>
                    <Typography textAlign={'center'} marginX={'auto'} >{"Store"}</Typography>
                </Link>
            </ListItem>
                ...
                <Box display={"flex"} justifyContent="space-between">
                    ...
                    <Box display={"flex"} gap={2}>
                        ...
                        <Stack sx={{
                            ...
                            direction="row" spacing={4} >
                            {[{ title: "Store", link: "https://store.konnektvpn.com/" }].map(({ title, link }, i) => (
                                <Link key={i} passHref href={link}>
                                    <div className="mx-1 my-auto cursor-pointer" >
                                        {title}
                                    </div>
